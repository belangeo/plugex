...
//==============================================================================
Plugex_02_amplitudeDbAudioProcessorEditor::Plugex_02_amplitudeDbAudioProcessorEditor (Plugex_02_amplitudeDbAudioProcessor& p,
    ...
    : AudioProcessorEditor (&p), processor (p), valueTreeState (vts)
{
    ...
    title.setText("Plugex - 02 - Amplitude in dB", NotificationType::dontSendNotification);
...
Plugex_02_amplitudeDbAudioProcessorEditor::~Plugex_02_amplitudeDbAudioProcessorEditor()
{
}

//==============================================================================
void Plugex_02_amplitudeDbAudioProcessorEditor::paint (Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (ResizableWindow::backgroundColourId));
}

void Plugex_02_amplitudeDbAudioProcessorEditor::resized()
{
