...
//==============================================================================
Plugex_09_butterworthBpAudioProcessorEditor::Plugex_09_butterworthBpAudioProcessorEditor (Plugex_09_butterworthBpAudioProcessor& p, AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), processor (p), valueTreeState (vts)
{
    ...
    title.setText("Plugex - 09 - Butterworth Bandpass", NotificationType::dontSendNotification);
...
Plugex_09_butterworthBpAudioProcessorEditor::~Plugex_09_butterworthBpAudioProcessorEditor()
{
...
//==============================================================================
void Plugex_09_butterworthBpAudioProcessorEditor::paint (Graphics& g)
{
    // (Our component is opaque, so we must completely fill the background with a solid colour)
    g.fillAll (getLookAndFeel().findColour (ResizableWindow::backgroundColourId));
}

void Plugex_09_butterworthBpAudioProcessorEditor::resized()
{
