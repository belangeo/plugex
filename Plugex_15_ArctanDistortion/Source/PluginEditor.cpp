...
//==============================================================================
Plugex_15_arctanDistortionAudioProcessorEditor::Plugex_15_arctanDistortionAudioProcessorEditor (Plugex_15_arctanDistortionAudioProcessor& p, AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), processor (p), valueTreeState (vts)
{
    ...
    title.setText("Plugex - 15 - Arctan Distortion", NotificationType::dontSendNotification);
...
Plugex_15_arctanDistortionAudioProcessorEditor::~Plugex_15_arctanDistortionAudioProcessorEditor()
{
...
//==============================================================================
void Plugex_15_arctanDistortionAudioProcessorEditor::paint (Graphics& g)
{
    // (Our component is opaque, so we must completely fill the background with a solid colour)
    g.fillAll (getLookAndFeel().findColour (ResizableWindow::backgroundColourId));
}

void Plugex_15_arctanDistortionAudioProcessorEditor::resized()
{
