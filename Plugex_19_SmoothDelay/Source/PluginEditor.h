...
/**
*/
class Plugex_19_smoothDelayAudioProcessorEditor  : public AudioProcessorEditor
{
public:
    Plugex_19_smoothDelayAudioProcessorEditor (Plugex_19_smoothDelayAudioProcessor&, AudioProcessorValueTreeState& vts);
...
private:
    ...
    Plugex_19_smoothDelayAudioProcessor& processor;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Plugex_19_smoothDelayAudioProcessorEditor)
};
