...
//==============================================================================
Plugex_19_smoothDelayAudioProcessorEditor::Plugex_19_smoothDelayAudioProcessorEditor (Plugex_19_smoothDelayAudioProcessor& p, AudioProcessorValueTreeState& vts)
    : AudioProcessorEditor (&p), processor (p), valueTreeState (vts)
{
    ...
    title.setText("Plugex - 19 - Smooth Delay", NotificationType::dontSendNotification);
...
Plugex_19_smoothDelayAudioProcessorEditor::~Plugex_19_smoothDelayAudioProcessorEditor()
{
...
//==============================================================================
void Plugex_19_smoothDelayAudioProcessorEditor::paint (Graphics& g)
{
    // (Our component is opaque, so we must completely fill the background with a solid colour)
    g.fillAll (getLookAndFeel().findColour (ResizableWindow::backgroundColourId));
}

void Plugex_19_smoothDelayAudioProcessorEditor::resized()
{
